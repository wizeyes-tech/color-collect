    ...
    <Layout language={`cn`}>
      ...
      <div className="article">
        ...
        <ul>
          ...
          <li>邮箱或者手机号：当你在注册色采账号时，需要使用邮箱或者手机号作为认证信息，你提交的邮箱或者手机号，我们会以加密的方式存储在服务器，我们不会将这些信息用于账号以外的其他功能</li>
          <li>密码：你账户的密码，我们会以强加密的形式，存储在我们的服务器，别人无法获取，甚至破解，此密码只有你知道。</li>
          <li>账单数据：作为一个支持云同步的应用，账单数据是云同步必备的功能，我们会将你的账单数据，存储在我们自己的服务器中，所有数据都经过高强度的安全保护，我们只会将你的账单提供给你自己使用，任何第三方都无法获得这些数据。</li>
        </ul>

        <p>请你理解，以上信息，均是色采为了提供正常服务所必须的，均由你主动提供，我们为你安全存储，如果你担心自己的账单数据安全，可以选择自己删除数据，我们为你提供的功能和服务是不断更新和发展的，如果某一项功能需要获取其他信息，我们会提前在官网、版本更新中另行向你说明。</p>
