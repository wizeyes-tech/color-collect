  ...
  return (
    <Layout language={`cn`}>
      ...
      <div className="article">
        ...
        <h3>(二) 永久购买</h3>
        <p>如你开通了永久购买，即代表你所获得的服务期限为无限期，即永久享受「色采」的功能服务。</p>

        <h2>二、付费服务</h2>
        <p>(一) 你理解并同意，会员订阅服务为付费服务，「色采」将收取互联网增值服务使用费；你可以在相关服务页面查阅会员订阅服务具体期限及对应费用并自行选择服务的种类。开启会员订阅功能后，无论你是否在相应服务期限内实际使用该服务或访问电子内容，已支付的费用不支持退款。</p>
        <p>(二) 你理解并同意，色彩软件开发工作室有权自行决定并不时修订会员订阅服务相关的收费标准和规则，该类标准及规则一经发布即生效，并构成本条款的有效组成部分。如你不同意前述标准、规则及其修订，你有权停止使用会员订阅服务。你继续使用会员订阅服务即视为你同意相关内容。</p>
