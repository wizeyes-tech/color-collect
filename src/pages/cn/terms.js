  ...
  return (
    <Layout language={`cn`} lanLink={`/terms-of-services/`}>
      ...
      <div className="article">
        ...
        <h3>1.4.2 永久购买</h3>
        <p>如你开通了永久购买，即代表你所获得的服务期限为无限期，即永久享受「色采」的本地高级版本功能服务。该条款仅限 iOS 端和安卓端的本地高级版本功能，不包括网页端与跨平台的数据同步功能。</p>
        ...
        <p>1.5.2 你理解并同意，色彩软件开发工作室有权自行决定并不时修订会员订阅服务相关的收费标准和规则，该类标准及规则一经发布即生效，并构成本条款的有效组成部分。如你不同意前述标准、规则及其修订，你有权停止使用会员订阅服务。你继续使用会员订阅服务即视为你同意相关内容。</p>
